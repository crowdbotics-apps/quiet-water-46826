"""
Django settings for quiet_water_46826 project.
...
ROOT_URLCONF = 'quiet_water_46826.urls'
...
WSGI_APPLICATION = 'quiet_water_46826.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_water_46826 API",
    "DESCRIPTION": "API documentation for quiet_water_46826 App",
    "VERSION": "v1",
}
